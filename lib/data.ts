...
export const featuredHorus: Project = {
  ...
  description:
    "A real-time CVE intelligence dashboard for security analysts. HORUS ingests live vulnerabilities from the NVD REST API, summarizes them in plain Thai/English with Groq Llama 3.3 70B, and answers follow-up questions through a streaming bilingual chat assistant — with one-click PDF export for offline triage.",
  highlights: [
    "Live CVE ingestion from the NVD REST API v2.0 with CVSS v3.1 / v3.0 / v2 score normalization and severity-band mapping",
    "Structured Thai-language summaries (affected systems, attacker capabilities, remediation urgency) generated by Groq Llama 3.3 70B",
