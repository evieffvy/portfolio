...
• SYCL Parallel Computing — Up to 2,194× GPU speedup (Block Frequency) and 160.5 Gbit/s peak throughput on NIST SP 800-22 randomness tests, benchmarked on NVIDIA RTX 4080 SUPER; single codebase across Intel/NVIDIA/AMD via SYCL/DPC++
